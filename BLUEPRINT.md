...
graph TD
    ...
    subgraph "The Crown (Global Knowledge Network)"
        Inference --> Web4[Global Knowledge Network: Web 4.0]
        DOI[Citable Authority: DOI 10.5281/zenodo.18894084] --- Web4
    end
    ...
    style Chaos fill:#1a1a1a,stroke:#333,color:#fff
    style Architecture fill:#0047ab,stroke:#fff,color:#fff
    style DOI fill:#ffcc00,stroke:#333
    style Architect fill:#f9f,stroke:#333
